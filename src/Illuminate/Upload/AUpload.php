...
namespace MyShopKitMBWP\Illuminate\Upload;
...
abstract class AUpload
{
    ...
    public function setImageSource(string $source): AUpload
    {
        if (!in_array($source, $this->_aValidSources)) {
            throw new RuntimeException(esc_html__('Invalid source', MYSHOPKIT_MB_WP_REST_NAMESPACE));
        }
